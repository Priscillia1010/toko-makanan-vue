            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <img
                      :src="'../assets/image/' + keranjang.product.gambar"
  ...
  methods: {
    ...
    hapusKeranjang(id) {
      axios
        ...
        .then(() => {
          this.$toastr.error("Berhasil hapus keranjang", {
            type: "error",
            position: "top-right",
            duration: 3000,
            dismissible: true,
      ...
      if (this.pesan.nama && this.pesan.noMeja) {
        ...
        axios
          ...
          .then(() => {
            ...
            this.$toastr.success("Berhasil dipesan", {
              type: "success",
              position: "top-right",
              duration: 3000,
              dismissible: true,
        ...
        this.$toastr.error("Nama dan nomor meja harus diisi", {
          type: "error",
          position: "top-right",
          duration: 3000,
          dismissible: true,
